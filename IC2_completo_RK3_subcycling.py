...
# Raio
ax1.plot(t_mr, raio_rk3_sub * 1e6, 'o-', color='#0D00FF', linewidth=1, markersize=2,
...
# Temperatura
ax2.plot(t_mr, temperatura_rk3_sub - 273.15, 'o-', color='#FF0000', linewidth=1,
         markersize=2, label=f'T_final = {temperatura_rk3_sub[-1] - 273.15} °C')
