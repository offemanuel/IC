...
# Raio
ax1.plot(tempo, raio_simp * 1e6,'^-', color='#FF0000',lw=2, ms=4,
...
# Temperatura
ax2.plot(tempo, temp_simp - 273.15, '^-', color='#FF0000',lw=2, ms=4,
...
# Massa
ax3.semilogx(tempo, massa_rk3, '^-', color='#FF0000',lw=2, ms=4,
...
plt.tight_layout()
#plt.show()
plt.savefig("grafico_dt_fixo_simplificacao_500.png")
